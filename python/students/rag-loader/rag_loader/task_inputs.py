"""Task inputs module for rag-loader — STUDENT STUB."""
...
class TaskInputs(BaseSettings):
    ...
    # TODO: add an inject_document_name: bool field (default False) that controls
    # whether "Pokémon: {name}\n\n" is prepended to each chunk in app.py.
